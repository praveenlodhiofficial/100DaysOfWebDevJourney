...
export function DocumentIcon(props: DocumentIconProps) {
    ...
    // </svg>
    return <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" strokeWidth="2" stroke="#3f434a" className={sizeVariants[props.size || "sm"]}>
