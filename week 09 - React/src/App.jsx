...
function App() {
  return (
    <div className="border p-5 justify-center items-start text-center font-[laila]" >
...
function Class12Program() {
  ...
  return (
    <div className="text-4xl p-40 flex flex-col gap-5 items-center">
      ...
      <button onClick={redirectUser} className="text-xl border px-3 py-2 text-center bg-black w-[20%] text-white rounded-md">Go Back to Home</button>
    </div>
  );
}
